  ...
  return (
    <div className="py-10 flex gap-10 flex-row justify-center relative flex-wrap">
      ...
      {CardItem?.map((item, index) => (
        <ComponentTransition
          className="w-full h-[350px] group md:basis-[31%] overflow-hidden bg-neutral-50 dark:bg-[#0a0a0a] border-[1px] dark:border-neutral-700 border-neutral-300 rounded-3xl"
          key={index}
          delay={index * 0.1}
        >
