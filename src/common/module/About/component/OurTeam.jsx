  ...
  return (
    <section className="w-full flex justify-center items-center py-12 md:py-24 lg:py-32 lg:px-10 px-5">
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 place-content-start place-items-start gap-6 mt-8">
          <div className="group">
            <Image
              alt="Team member"
              className=" overflow-hidden rounded-3xl object-cover object-center sm:w-full group-hover:scale-105 transition-transform"
              height={50}
