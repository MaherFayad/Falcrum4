  ...
  return (
    <section className="w-full flex justify-center items-center py-12 md:py-24 lg:py-32">
      <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 place-content-start place-items-start gap-8 lg:gap-10 mt-8">
          ...
          {/* <div className="group pb-2">
            ...
            />
            <div className="lg:mt-4 text-left max-lg:text-center">
              <h1 className="text-2xl font-bold">Lars Wood</h1>
          ...
          <div className="group pb-2">
            <Image
              ...
              className=" overflow-hidden rounded-3xl object-cover object-center max-lg:w-48 max-lg:h-48 max-lg:rounded-full max-lg:mx-auto  w-full group-hover:scale-105 transition-transform"
              height={50}
              src="https://firebasestorage.googleapis.com/v0/b/falcrum4-7eb0b.appspot.com/o/Team%2FArmen.webp?alt=media&token=001f8bf0-c44e-4f41-938d-c416ca028bba"
              width={50}
              priority
            />
            <div className="lg:mt-4 text-left max-lg:text-center">
              <h1 className="text-2xl font-bold">Armen Khachatrian</h1>
          ...
          <div className="group pb-2">
            <Image
              ...
              className=" overflow-hidden rounded-3xl object-cover object-center max-lg:w-48 max-lg:h-48 max-lg:rounded-full max-lg:mx-auto  w-full group-hover:scale-105 transition-transform"
              height={50}
              src="https://firebasestorage.googleapis.com/v0/b/falcrum4-7eb0b.appspot.com/o/Team%2FGrigory.webp?alt=media&token=ce8999c8-ba75-4328-9151-0dbd4a621287"
              width={50}
              priority
            />
            <div className="lg:mt-4 text-left max-lg:text-center">
              <h1 className="text-2xl font-bold">Grigory Yusufov</h1>
