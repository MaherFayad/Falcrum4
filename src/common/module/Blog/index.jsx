...
const Blog = ({ className = "" }) => {
  return (
    <div className={`${className} h-auto max-w-[1500px] px-5 lg:px-10 xl:px-20 pb-20 lg:mt-20 mt-10`}>
      ...
      <ComponentTransition delay={0.1} className="flex justify-center items-center flex-col">
        ...
        <p className="lg:text-2xl md:text-xl text-lg text-neutral-500 dark:text-neutral-300 md:w-[100%] text-center w-full">
