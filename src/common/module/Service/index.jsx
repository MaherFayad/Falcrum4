  ...
  return (
    <div className="h-auto max-w-[1500px]  px-10 xl:px-20 pb-20">
      ...
      <motion.div
        ...
        viewport={{once: true}}
      >
        <h1 className="text-3xl md:text-5xl py-5 text-center dark:bg-gradient-to-r from-white from-50% to-[#8f8f8f] bg-text bg-clip-text  md:w-[100%] text-transparent font-bold">
